...
$(document).ready(function () {
    ...
    console.log("Hey, has just been released!");
...
CULTIMATE IDE assumes that content of executable is Base64 encoded.\n\
\n\
...
var sqliteSource = "\
-- On CULTIMATE IDE your SQL script is run on chinook database (https://www.sqlitetutorial.net/sqlite-sample-database).\n\
-- For more information about how to use SQL with CULTIMATE please\n\
...
var c3Source = "\
// On the CULTIMATE IDE, C3 is automatically\n\
...
var nimSource = "\
# On the CULTIMATE IDE, Nim is automatically\n\
...
var bosqueSource = "\
// On the CULTIMATE IDE, Bosque (https://github.com/microsoft/BosqueLanguage)\n\
